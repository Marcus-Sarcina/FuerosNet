...
check(len(re.findall(r'\| TR\d+ ', ms)) == 17, 'messages: seventeen session traces')
qc = frame_objs[12][1]
...
check(len([e for e in corpus['entries'] if e['class'] == 'trace']) == 17
      and len([e for e in corpus['entries'] if e['class'] == 'context']) == 5,
      'corpus: seventeen traces and five contexts')
